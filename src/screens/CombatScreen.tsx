...
import { useSoundFX, getMuted, setMuted } from '../hooks/useSoundFX';
      ...
      {isAutoRun && (
        <div className="flex items-center justify-between bg-amber-600/20 border border-amber-500/30 px-4 py-2">
          ...
          <div className="flex gap-2">
            <button onClick={() => { const v = !muted; setMuted(v); setMutedState(v); }}
              className="px-2 py-1 bg-secondary rounded text-sm hover:opacity-80"
